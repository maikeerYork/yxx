<template>
  <div id="box">
    <div class="box_left">
      ...
      <el-tree :data="list" :props="defaultProps" @node-click="handleNodeClick" node-key="id"></el-tree>
    </div>
    <div id="box_right">
      <div class="box_right_top" id="box_right_top">
        ...
        <div style="width:100%;height: 100%; " v-else-if="multilayer_num == 2 " class="multilayer2">
          <div id="wrapper_1"></div>
          <div id="wrapper_2"></div>
          <div id="wrapper_3"></div>
          <div id="wrapper_4"></div>
        </div>
        <div style="width:100%;height: 100%; " v-else-if="multilayer_num == 3 " class="multilayer3">
        ...
        <div style="width:100%;height: 100%; " v-else-if="multilayer_num == 4 " class="multilayer4">
        ...
        <div style="width:100%;height: 100%; " v-else-if="multilayer_num == 5 " class="multilayer5">
          <div id="wrapper_1"></div>
          <div id="wrapper_2"></div>
          <div id="wrapper_3"></div>
          <div id="wrapper_4"></div>
        ...
        <div style="width:100%;height: 100%; " v-else-if="multilayer_num == 6 " class="multilayer6">
          <div id="wrapper_1"></div>
          <div id="wrapper_2"></div>
          <div id="wrapper_3"></div>
          <div id="wrapper_4"></div>
      ...
      <div class="box_right_botton">
        ...
        <div class="right">
          <div  @click="toggleFullscreen" alt="" style="display:flex;align-items: center;">
...
export default {
  ...
  methods:{
    ...
    async oo(){
      ...
      this.src.push(res.data.data[0].child[0].play_url) 
      this.setVideo()
      },
    handleNodeClick(a){
      console.log(a,'a');
...
.multilayer4{
  ...
  .multilayer4_right{
    ...
    height: 100%;
    border: 1px solid rgb(194, 91, 91);
    .multilayer4_right_top,.multilayer4_right_content,.multilayer4_right_botton{
      width: 100%;
      height: 33.3%;
      border: 1px solid rgb(194, 91, 91);
    }
