...
<!--                  <el-form-item label="单据">
                    <el-input v-model="document" placeholder="请输入内容"></el-input>
                  </el-form-item>-->
      ...
      <el-table :data="purchaseSummaryList" size="mini" v-loading="loading" :header-cell-style="{'text-align':'center','color':'#000'}">
        <el-table-column type="index" label="单据编号"/>
        <el-table-column prop="type_name" label="采购机构" />
        <el-table-column prop="raw_no" label="采购食堂" />
        <el-table-column prop="raw_name" label="食材" />
        <el-table-column prop="spec" label="数量" />
        <el-table-column prop="whouse_name" label="价格" />
        <el-table-column prop="unit_purc" label="金额" />
        <el-table-column prop="num" label="单位" />
        <el-table-column prop="num" label="供应商" />
        <el-table-column prop="num" label="下单人" />
        <el-table-column prop="num" label="申请时间" />
        <el-table-column prop="num" label="数据来源" />
...
<!--        <el-table-column label="退款总金额" >
          <template slot-scope="scope"><div class="text-red">￥{{scope.row.sum | price}}</div> </template>
        </el-table-column>-->
      </el-table>
      <div class="paging">
