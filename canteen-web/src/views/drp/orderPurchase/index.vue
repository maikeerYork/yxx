  ...
  <div>
    ...
    <el-card class="box-shadow-none m-20" :body-style="{ padding: '0' }">
              ...
              <div>
                <el-form size="small" inline>
                  ...
                  <el-form-item label="采购食堂：">
                    <template>
                      <el-select v-model="purchaseValue" clearable placeholder="请选择">
                        <el-option
      ...
      <el-table :data="purchaseSummaryList" size="mini" v-loading="loading" :header-cell-style="{'text-align':'center','color':'#000'}">
        <el-table-column type="food_name" label="食材名称"/>
        <el-table-column prop="type_name" label="食材分类名称" />
        <el-table-column prop="raw_no" label="供应商" />
        <el-table-column prop="raw_name" label="数量" />
        <el-table-column prop="spec" label="单价" />
        <el-table-column prop="whouse_name" label="单位" />
        <el-table-column prop="unit_purc" label="剩余库存" />
