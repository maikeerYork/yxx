      ...
      <div class="saleNumber">
        <div>
          <div class="minbox borders">
            ...
            <div class="postionNumber">{{ totalData.dish_count }}</div>
          </div>
        </div>
        <div>
          <div class="minbox">
            <div class="postiongBox">饮料总类型（种）</div>
            <div class="postionNumber">{{ totalData.code_count }}</div>
          </div>
        </div>
        <div>
          <div class="minbox">
            <div class="postiongBox">餐盘总销量（份）</div>
            <div class="postionNumber">{{ totalData.sell_dish }}</div>
          </div>
        </div>
        <div>
          <div class="minbox">
            <div class="postiongBox">饮料总销量（份）</div>
            <div class="postionNumber">{{ totalData.sell_code }}</div>
          </div>
        </div>
        <div>
          <div class="minbox">
            ...
            <div v-if="totalData.sell_money" class="postionNumber">{{ totalData.sell_money | price }}</div>
...
import { getTotalBase, getTotalBaseTrend, getTotalBasePct, getPayType } from '@/api/businessStatistics'
...
export default {
  ...
  methods: {
    ...
    sendDaytime(currentDay) {
      ...
      this.downExcelurl = kang_url + '/excel/multiple/SaleTrend' + '?' + 'canteen_id=' + this.initsendInfo.canteen_id + '&' + 'client_id=' + this.initsendInfo.client_id + '&' + 'date_start=' + this.initsendInfo.date_start + '&' + 'date_end=' + this.initsendInfo.date_end + '&' + 'date_type=' + this.initsendInfo.date_type

      this.downExcelurl2 = kang_url + '/excel/multiple/SaleRate' + '?' + 'canteen_id=' + this.initsendInfo.canteen_id + '&' + 'client_id=' + this.initsendInfo.client_id + '&' + 'date_start=' + this.initsendInfo.date_start + '&' + 'date_end=' + this.initsendInfo.date_end + '&' + 'pct_type=' + this.initsendInfo.date_type

      this.downExcelurl3 = kang_url + '/excel/multiple/PayTypeRate' + '?' + 'canteen_id=' + this.initsendInfo.canteen_id + '&' + 'client_id=' + this.initsendInfo.client_id + '&' + 'date_start=' + this.initsendInfo.date_start + '&' + 'date_end=' + this.initsendInfo.date_end
    },
    ...
    totlaBaseInfo() {
      ...
      this.$nextTick(function() {
        ...
        getTotalBase(obj).then(response => {
    ...
    // 基础统计走势
    TotalBaseTrend() {
      getTotalBaseTrend(this.initsendInfo).then(response => {
    ...
    TotalBasePct() {
      this.$nextTick(function name() {
        ...
        getTotalBasePct(obj).then(response => {
